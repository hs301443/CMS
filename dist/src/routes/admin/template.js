...
router.post("/", Multer_1.uploadTemplate.single("template_file"), template_1.createTemplate);
router.get("/", template_1.getAllTemplates);
router.get("/:id", template_1.getTemplateById);
router.patch("/:id", Multer_1.uploadTemplate.single("template_file"), template_1.updateTemplate);
